...
def insertpatient():
    ...
    #     doc = file.read()
    # with open('./testpatient/p0000.json','r') as file:
    #     doc = file.read()
    # doc = json.loads(doc)
    prevLeastRuntime = 0
    # for loop for testing 160 patients
    # for i in range(161):
    #     #print(doc_string)
    #     #runtime_xbar = 0
    #     #leastruntime = 2
    ...
    #         j = "0"+ j
    #     id = "p"+j
    #for loop for testing 1000-10000 patients attributes
    for i in range(1000,10001,1000):
        ...
        #doc_encrypted, runtime = JSONCryptoPerf.encryptjson(id,certid)
        runtime_list = []
        for k in range(10):
            start = time.time()
